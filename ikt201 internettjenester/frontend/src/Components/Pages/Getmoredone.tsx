...
function GetMoreDone() {
  const style = useStyles()

  return (
    <section className={style.section}>
      <h3 className={style.h3}>Get More Done with Freelancerfy!</h3>
      <p className={style.p}>
        get stuff done with freelancerfy because we da best
      </p>
      <div className={style.services_grid}>
        ...
        <div className={style.service2}>
          <h4 className={style.service2_h4}>
            Hire freelancers at Freelancerfy at a fraction of the cost
          </h4>
          <p>Find yourself a designer, programmer, or a developer</p>
        </div>

        <div className={style.service3}>
          <h4 className={style.service3_h4}>
            Don`t regret a bad hire by hiring our Pros
          </h4>
          <p>Read reviews of our freelancers or hire one of our pros!</p>
        </div>
      </div>
    </section>
  )
